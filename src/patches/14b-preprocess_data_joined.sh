...
for DATASET1 in "CCAligned" "wmt19m" "EuroPat"; do
    ...
    for PREFIX2 in "orig" "teacher"; do
        for LANGS in "en-de" "de-en"; do
            ...
            TEXT_DIR="data_bin/${DATASET2}.de-en.bpe_${DATASET1}.${PREFIX1}-${PREFIX2}.${LANG1}-${LANG2}.double/";
            mkdir -p ${TEXT_DIR};
            ...
            head -n 960000 ${TEXT_SRC_ORIG} >> "${TEXT_DIR}/train.${LANG1}";
            ...
            head -n 960000 ${TEXT_TGT_ORIG} >> "${TEXT_DIR}/train.${LANG2}";
